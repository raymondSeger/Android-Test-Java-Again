...
public class MpAndroidChartActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        for (int i = 0; i < progress; i++) {
            ...
            values.add(new CandleEntry(
                    ...
                    getResources().getDrawable(R.drawable.flag_afghanistan)
            ));
        }
