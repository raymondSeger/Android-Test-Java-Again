...
public class TryBackButtonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_try_back_button);
        ...
        goToActivity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity.this, TryBackButtonActivity.class);
        ...
        goToActivity2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity.this, TryBackButtonActivity2.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity.this, TryBackButtonActivity3.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity.this, TryBackButtonActivity4.class);
                startActivity(intent);
            }
        });
