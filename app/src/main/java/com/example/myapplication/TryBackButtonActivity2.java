...
public class TryBackButtonActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_try_back_button2);
        ...
        goToActivity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity2.this, TryBackButtonActivity.class);
        ...
        goToActivity2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity2.this, TryBackButtonActivity2.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity2.this, TryBackButtonActivity3.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity2.this, TryBackButtonActivity4.class);
                startActivity(intent);
            }
        });
