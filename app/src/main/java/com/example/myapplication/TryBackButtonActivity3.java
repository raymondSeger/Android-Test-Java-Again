...
public class TryBackButtonActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_try_back_button3);
        ...
        goToActivity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity3.this, TryBackButtonActivity.class);
        ...
        goToActivity2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity3.this, TryBackButtonActivity2.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity3.this, TryBackButtonActivity3.class);
                startActivity(intent);
            }
        });
        ...
        goToActivity4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TryBackButtonActivity3.this, TryBackButtonActivity4.class);
                startActivity(intent);
            }
        });
