...
import static com.example.myapplication.ExampleAppWidgetConfig5.KEY_BUTTON_TEXT;
import static com.example.myapplication.ExampleAppWidgetConfig5.SHARED_PREFS;

public class ExampleAppWidgetProvider5 extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent serviceIntent                = new Intent(context, ExampleWidgetService5.class);
            ...
            RemoteViews views                   = new RemoteViews(context.getPackageName(), R.layout.example_widget_5);
